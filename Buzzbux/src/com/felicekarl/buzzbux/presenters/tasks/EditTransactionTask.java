...
public class EditTransactionTask extends AsyncTask<String, Void, String> {
	@SuppressWarnings("unused")
	private static final String TAG = EditTransactionTask.class.getSimpleName();
	...
	protected String doInBackground(String... params) {
        ...
        nameValuePairs.add(new BasicNameValuePair(Network.TAG_OMA_TRANSACTION_DIFF, params[5]));
        nameValuePairs.add(new BasicNameValuePair(Network.TAG_OMA_TRANSACTION_DESC, params[6]));
        nameValuePairs.add(new BasicNameValuePair(Network.TAG_OMA_TRANSACTION_DATE, params[7]));
